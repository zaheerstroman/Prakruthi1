                ...
                if (putData.onComplete()) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            myOrdersModals.add(new MyOrdersModal(id,user_id,quantity,amount,order_id,status,is_paid,invoice_id,tracking_status,tracking_id,partner_name,attachment,name));
                        }
